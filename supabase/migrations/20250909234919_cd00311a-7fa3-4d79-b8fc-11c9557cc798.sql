...
ALTER TABLE public.trips ADD COLUMN peso_ton numeric;
ALTER TABLE public.trips ADD COLUMN volume_m3 numeric;
ALTER TABLE public.trips ADD COLUMN observacoes text;

-- Update status enum to match requirements (Planejada, Em_Andamento, Concluída)
